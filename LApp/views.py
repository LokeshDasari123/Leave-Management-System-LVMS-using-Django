...
from .forms import AusForm,UsuserForm,UpForm,TchprForm,UspForm,StpForm,LeavForm,UpleaForm,chgPwdForm
...
def tchlevlst(request):
    ...
    for z in p:
        ...
        for v in q:
            m[v.id]=v.leavetype,v.appldate,v.leavestatus,p[v.st_id][1],p[v.st_id][0],v.id 
