...
class LeavForm(forms.ModelForm):
	class Meta:
		model=Leave
		fields = ["leavetype","startdate","enddate","leaveatch","reason"]
		widgets = {
...
class UpleaForm(forms.ModelForm):
	class Meta:
		model =Leave
		fields=["leavetype","appldate","leavestatus","tchdescc"]
		widgets={
			"leavetype":forms.Select(attrs={
				"class":"form-control my-2",
				"readonly":"true",
				}),
			"appldate":forms.DateInput(attrs={
				"class":"form-control my-2",
				"type":"date",
				"readonly":"true",
				}),
